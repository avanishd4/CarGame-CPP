...
class GameTemplate{
	...
	// display score section on top right corner                                                                  
	void score_section()
	{
    	gotoxy(65, 4);
	...
	// Left and right track line                        (4 units ) horizontal
	...
	void draw_game()
	{
   		for (int j = 0; j<26; j++) {
            ...
            track_left_right(j);                                                //Drawing Left and right track line  from top to bottom (vertical)
	...
	/// Moving the player's Car
		...
		while (1) {               
			...
			if (Xlngt == 12) {
				...
				else if (chrGetKey == 'd' || chrGetKey=='D') {
